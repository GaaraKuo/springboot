...
import com.gaara.ybbweb.repository.LoggerJpaRepository;
import com.gaara.ybbweb.utils.LoggerUtils;
...
public class LoggerInterceptor implements HandlerInterceptor
{
  ...
  public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object o) throws Exception {
    ...
    //设置请求类型（json|普通请求）
    logger.setType(request.getContentType());
    //设置请求参数内容json字符串
  ...
  public void afterCompletion(HttpServletRequest request, HttpServletResponse response, Object o, Exception e) throws Exception {
    ...
    loggerEntity.setReturnData(JSON.toJSONString(request.getAttribute(LoggerUtils.LOGGER_RETURN),
        ...
        SerializerFeature.WriteMapNullValue));
    //执行将日志写入数据库
    LoggerJpaRepository loggerDAO = getDAO(LoggerJpaRepository.class,request);
